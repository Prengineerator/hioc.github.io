-- =====================================================================
-- HIOC — consolidated DB migration. Run ONCE, top to bottom.
-- Order matters: phase3 (schema) -> order-email -> menu short_code.
-- Idempotent EXCEPT the "create policy" statements in the phase-3
-- sections: if you have applied part of this before, those throw a
-- harmless  policy "..." already exists  — safe to ignore.
-- Source of truth = the individual files under supabase/; edit those.
-- =====================================================================


-- ========== 1/3 :: supabase/phase3-migration.sql ==========
...
-- ========== 2/3 :: supabase/2026-07-order-email.sql ==========
...
-- ========== 3/3 :: supabase/2026-07-menu-short-code.sql ==========
