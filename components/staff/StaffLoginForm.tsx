...
// PIN-2 — the classic sign-in form itself. Split out of app/staff/login/page.tsx
// so that file can be a Server Component: it needs to redirect a PIN-capable
// counter straight to the lock screen (getEnrolledDevice() + flags.pinSwitch,
// server-side) BEFORE this form ever renders, and a Server Component can't
// live in the same file as one marked 'use client'.
